...
class JobConfirmCanceledPage extends StatefulWidget {
  final String sTitle;
  final String jobID;
  final String workerID;
  JobConfirmCanceledPage({Key key, this.sTitle, this.jobID, this.workerID})
      : super(key: key);

  @override
  _JobConfirmCanceledPageState createState() => new _JobConfirmCanceledPageState();
}

class _JobConfirmCanceledPageState extends State<JobConfirmCanceledPage> {
          ...
          child: new Container(
              ...
              child: new SingleChildScrollView(
                ...
                (_bUpdating)
                    ...
                    : new Container(),
                createTextField(" העבודה בוטלה", null, null, null,
