...
class JobConfirmFiredPage extends StatefulWidget {
  ...
  JobConfirmFiredPage({Key key, this.sTitle, this.jobID, this.workerID}) : super(key: key);
            ...
            child: Column(
              children: <Widget>[
                ...
                (_bUpdating) ? new CircularProgressIndicator(backgroundColor: Theme.Colors.zarizGradientStart):new Container(),
                  createTextField(" הוחלט שלא להעסיק אותך",  null, null, null, textSize: 32.0, bCenter:true),
